...
function UpdateQuiz() {
    ...
    useEffect(() => {
        ...
        const fetchTags = async () => {
            try {
                const response = await axios.get("https://aasu.pythonanywhere.com/tags/");
    ...
    const handleAPi = async (e) => {
        ...
        try {
            const response = await axios.put(`https://aasu.pythonanywhere.com/quize/update/${id}/`, formData, {
                headers: {
                    Authorization: `Bearer ${user.token.access}`,
            ...
            <form onSubmit={handleAPi} encType="multipart/form-data">
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        >
                            {tags.map(tag => (
                                <option key={tag.id} value={tag.id}>{tag.tage_name}</option>
                            ))}
                        </select>
                    </div>
                    <div>
