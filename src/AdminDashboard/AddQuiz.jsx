...
const AddQuiz = (headers = {}) => {
  ...
  useEffect(() => {
    const fetchTagHeadings = async () => {
      try {
        const response = await axios.get("https://exam.advicekoreanlearningcenter.com/tags/");
  ...
  return (
    <div className="container mx-auto p-8">
      <div className="flex justify-between items-center mb-6 mt-6">
        <div className="text-gray-700 sans-serif-text text-3xl ml-0">Quiz List</div>
        <div>
          <Link to="/listquize">
            ...
            <div className="relative">
              ...
              {dropdownOpen && (
                <div className="absolute z-10 mt-1 w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                  ...
                  <ul ref={optionsListRef} className="p-2 max-h-60 overflow-auto">
